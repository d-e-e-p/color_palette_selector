...
// python conversion has problems translating Math.cbrt
function cbrt(x){
...
function find_cusp(a, b)
{
	...
	let L_cusp = cbrt(1 / Math.max(Math.max(rgb_at_max[0], rgb_at_max[1]), rgb_at_max[2]));
...
function okhsv_to_srgb(h,s,v)
{
    ...
    let scale_L = cbrt(1/(Math.max(rgb_scale[0],rgb_scale[1],rgb_scale[2],0)));
...
function srgb_to_okhsv(r,g,b)
{
    ...
    scale_L = cbrt(1/(Math.max(rgb_scale[0],rgb_scale[1],rgb_scale[2],0)));
